...
void setup() {
  ...
  //buzzerHandler.finishPulses(); // blocks untill the pulse is completed
}
void loop() { 
  bool stillGoing = buzzerHandler.loop(); // required to complete the pulses
  // you are free to do other stuff while the pulse completes
}